			...
			<div class="panel panel-default">
		    	<div class="panel-heading" role="tab" id="headingOne">
		      		<h4 class="panel-title">
		        		<a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $i ?>" <?php if($i == 1){ ?> aria-expanded="true" <?php } else{ ?> class="collapsed" aria-expanded="false" <?php } ?> aria-controls="collapse<?php echo $i ?>">
